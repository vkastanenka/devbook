...
class Github extends Component {
  ...
  async componentDidMount() {
    if (this.props.users.user.user.profile.githubusername) {
      const githubusername = this.props.users.user.user.profile.githubusername;
        ...
        <li className="content-card__list-entry repository" key={repo.id}>
          ...
          <div className="repository__statistics">
            <p className="repository__statistics--stars text-secondary">
              <span className="fw-medium">Stars:</span> {repo.stargazers_count}
            </p>
            <p className="repository__statistics--watchers text-secondary">
              <span className="fw-medium">Watchers:</span> {repo.watchers_count}
            </p>
